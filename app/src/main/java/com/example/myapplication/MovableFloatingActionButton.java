...
//                return false;
    ...
    public void setCordinates(View view,DetectPaper.Quadrilateral quadrilateral,int x){
        this.dX= (float) quadrilateral.points[x].x;
        this.dY= (float) quadrilateral.points[x].y;
        view.animate()
                .x(dX)
                .y(dY)
                .setDuration(0)
